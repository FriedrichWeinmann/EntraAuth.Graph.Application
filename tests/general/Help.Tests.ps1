...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\EntraAuth.Graph.Application\functions", "$global:testroot\..\EntraAuth.Graph.Application\internal\functions"),
	
	[string]
	$ModuleName = "EntraAuth.Graph.Application",
...
$CommandPath = @(
    "$global:testroot\..\EntraAuth.Graph.Application\functions"
    "$global:testroot\..\EntraAuth.Graph.Application\internal\functions"
)
