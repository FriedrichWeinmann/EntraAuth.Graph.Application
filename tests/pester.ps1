...
Remove-Module EntraAuth.Graph.Application -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\EntraAuth.Graph.Application\EntraAuth.Graph.Application.psd1"
Import-Module "$PSScriptRoot\..\EntraAuth.Graph.Application\EntraAuth.Graph.Application.psm1" -Force
