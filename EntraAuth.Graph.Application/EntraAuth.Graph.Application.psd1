...
GUID = '0e924a37-8ca3-4919-b2ff-96b27794eec5'
...
Description = 'EntraAuth based module to manage App Registrations and Enterprise Apps, request scopes and grant them.'
...
FormatsToProcess = @('EntraAuth.Graph.Application.Formats.ps1xml')
...
FunctionsToExport = @(
	...
	'Remove-EAGAppScope'
	'Remove-EAGMsiScope'
	'Remove-EAGServicePrincipal'
	'Revoke-EAGScopeConsent'
)
